<template>
  <div>
    ...
    <div class="info">
      <Checkbox v-model="remember"><span>记住用户名</span></Checkbox>
  ...
  methods: {
    ...
    setCookie(c_name, exdays) {
      ...
      window.document.cookie =
        "username" + "=" + c_name + ";path=/;expires=" + exdate.toGMTString(); //字符串拼接cookie
    },
    /**
     * 登录账户，发送登录鉴权请求
        ...
        this.axios
          ...
          .then(res => {
            if (res.data.code === 200) {
              ...
              // let userid = res.data.account_level.toString()      // 用户身份，acco000000000000000000000000000untLevel，1111为管理员，1110为普通用户
              ...
              setTimeout(() => {
                this.$router.push("/system/taskScenario");
              }, 2000);
            } else {
