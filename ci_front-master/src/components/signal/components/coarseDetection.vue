...
export default {
  ...
  methods: {
    ...
    filterClick(params) {
      ...
      this.selectParam.altRegion = params[2];
      this.selectParam.updatestartTime = params[3];
      this.selectParam.updateendTime = params[4];
      this.tableData = [];
      this.getCoaDetec();
    },
    resetData() {
    ...
    getCoaDetec() {
      this.axios({
        url: "/api/data/original/signal/coarseDetection",
        method: "post",
        data: {
